    ...
    if (isAddSchedule) {
      ...
      if (ret.type === "MatchSchedule/addMatchSchedule/fulfilled") {
        if (ret?.payload?.error) {
          toast.error(ret?.payload?.error, { theme: "colored" });
  ...
  const onRowUpdated = (e) => {
    ...
    if (leaguageId && leaguageId > 0) {
      ...
      const payload = {
        ...
        ScreenNumber: datas.ScreenNumber,
        IsEnd: datas.IsEnd,
      };
    ...
    <React.Fragment>
      ...
      {isMobile ? (
            ...
            <Modal show={showPopup} onHide={handleClose}>
              <Modal.Header closeButton>
                <Modal.Title className="text-center">
                  <b>Sân {itemData ? itemData.StadiumNumber : 0}</b>
                </Modal.Title>
              </Modal.Header>
              <Modal.Body>
                {itemData && (
        ...
        >
          ...
          <Column dataField="ScreenNumber" caption={"Màn hình "}>
            <Lookup
              dataSource={ScreenNumber}
              displayExpr={"Name"}
              valueExpr={"Id"}
            />
          </Column>
          ...
          <Column
            ...
            width={250}
            cellRender={(cellData) => (
              <Score data={cellData.data} onScoreChange={onScoreChange} />
            )}
          />
